...
function Employee_edit({employee}) {
    ...
    const { data, setData, put, processing, errors, reset } = useForm({
        ...
        g_name: employee.g_name,
        gender: employee.gender,
        experience: employee.experience,
        nid: employee.nid,
        religion: employee.religion,
        last_edu: employee.last_edu,
        ...
        >
            ...
            <div className="lg:grid grid-cols-3 gap-2 mb-3">
                ...
                <div className="col-span-1">
                    <div className="my-3">
                        <FloatLabel>
                            <Calendar id="join_date" value={data.join_date ? new Date(data.join_date) : null } onChange={(e) => setData('join_date', e.target.value)} className="w-full mb-1" />
